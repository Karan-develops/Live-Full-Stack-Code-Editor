...
const page = () => {
  return (
    ...
    <div className="max-w-4xl mx-auto p-6 bg-gradient-to-br from-blue-800 to-blue-600 text-white rounded-lg shadow-lg transform hover:scale-105 transition-transform duration-300 mt-10">
            ...
            <p className="mt-6 text-center animate-slide-in-right">For any questions, contact us at <a href="mailto:mrkaran2k5@gmail.com" className="text-blue-400 underline">terms@karan's-codeCanva.com</a>.</p>
        </div>
    </div>
  )
}
